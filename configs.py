...
class Config(object):
    API_ID = int(os.getenv("API_ID", "24575563"))
    API_HASH = os.getenv("API_HASH", "2b1446a709b6f1bb894093a368884fac")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5882708377:AAFzbHxVi1lEMb-xEqGhvHn4v1f7Il4kueU")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "moviessearchbot")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "1BVtsOGgBu7nujOylIBRgFRJZzV0sH1POejrPe9nDpGn_FDhGiozYcxOtPqv7HktJ4jbDf3VVVEkTL5UnJ65SCDVfwijuINb5O8fmCcTjnT42T0g3NsXIVQKlmlW9voLTQnNPhLedkUqf0ecng1n0P8HafQ0IcuuuCWcmEl_x5rqkrqOiVt3vSGCthjkbfx3ToLsnZR1X8rQiWJ-ZyWOdnnfY2Ad8mH7dACg3iQ36mfDQyKSnoicudywpUs45lpGlgMWI9h00cFXcz5awak-U81QoOnk4HcbujLBXOM7EFVm9uyYE8lrmhZPCp0x4lRdfpnyZ_btBtD6tbbuW75HRLNhpl_hnCwo=")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001858898420")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "Moviessearch26bot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "5271093289"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "Promoter8047")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "tryboty")
#    GROUP_USERNAME = os.getenv("GROUP_USERNAME", "newhdmovies27")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001864170028")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://Jakharboy:8059530482@cluster0.chu0d2x.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001810640244"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "moviebotupdate515")
    FORCE_SUB = os.getenv("FORCE_SUB", "False")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 600))
    MDISK_API = os.getenv("MDISK_API", "yLhtKHSZfZKvs4YB3Hyr")
